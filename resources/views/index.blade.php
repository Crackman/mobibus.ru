		    		...
		    		<div class="header col-12 d-flex justify-content-between align-items-center flex-wrap">
		    			...
		    			<div class="contacts d-flex justify-content-between align-items-center flex-wrap">
		    				<div class="tel-block d-flex justify-content-sm-between justify-content-center align-items-end">
		    					...
		    					<div>
			    					<a href="tel:+79517150552">+7 (951) 715 05 52</a>
				...
				<div class="characteristics col-12">
					...
					<div class="grid">
						<div class="item item1 wow fadeInLeft" data-wow-duration="2s">
							<div class="img-block"><img src="../../public/images/item1.png" alt="icon"></div>
							<div class="desc">
								<h3>Выгодная цена</h3>
						...
						<div class="item item2 wow fadeInUp" data-wow-duration="2s">
							<div class="img-block"><img src="../../public/images/item2.png" alt="icon"></div>
							<div class="desc">
						...
						<div class="item item3 wow fadeInRight" data-wow-duration="2s">
							<div class="img-block"><img src="../../public/images/item3.png" alt="icon"></div>
							<div class="desc">
						...
						<div class="item item4 wow fadeInLeft" data-wow-duration="2s">
							<div class="img-block"><img src="../../public/images/item4.png" alt="icon"></div>
							<div class="desc">
						...
						<div class="item item5 wow fadeInUp" data-wow-duration="2s">
							<div class="img-block"><img src="../../public/images/item5.png" alt="icon"></div>
							<div class="desc">
						...
						<div class="item item6 wow fadeInRight" data-wow-duration="2s">
							<div class="img-block"><img src="../../public/images/item6.png" alt="icon"></div>
							<div class="desc">
						...
						<div class="item item7 wow fadeInLeft" data-wow-duration="2s">
							<div class="img-block"><img src="../../public/images/item7.png" alt="icon"></div>
							<div class="desc">
						...
						<div class="item item8 wow fadeInUp" data-wow-duration="2s">
							<div class="img-block"><img src="../../public/images/item8.png" alt="icon"></div>
							<div class="desc">
						...
						<div class="item item9 wow fadeInRight" data-wow-duration="2s">
							<div class="img-block"><img src="../../public/images/item9.png" alt="icon"></div>
							<div class="desc">
			...
			<div class="container">
				<div class="row">
					<div class="col-12">
						...
						<div class="grid">
							<div class="item item1 wow fadeInLeft" data-wow-duration="2s">
								<img class="img" src="../../public/images/kids-item1.jpg" alt="img">
								<div class="wrap">
									<h3>Глянцевые потолки</h3>
									<span class="item-price">от 1100 Тг</span>
									<div>
										<span><img src="../../public/images/chech1.png" alt="img">Бесплатный cервис</span>
										<span><img src="../../public/images/chech1.png" alt="img">С установкой</span>
									</div>
									<button data-toggle="modal" data-target="#zamer">Оставить заявку</button>								
								</div>
							</div>
							<div class="item item2 wow fadeInUp" data-wow-duration="2s">
								<img class="img" src="../../public/images/kids-item2.jpg" alt="img">
								<div class="wrap">
							...
							<div class="item item3 wow fadeInRight" data-wow-duration="2s">
								<img class="img" src="../../public/images/kids-item3.jpg" alt="img">
								<div class="wrap">
				...
				<div class="texnology col-12">
					...
					<div class="grid">
						<div class="wow fadeInLeft" data-wow-duration="2s">
							<img src="../../public/images/texnology-item1.jpg" alt="img">
							<h3>Двухуровневые</h3>
						</div>
						<div class="wow fadeInUp" data-wow-duration="2s">
							<img src="../../public/images/texnology-item2.jpg" alt="img">
							<h3>Светопропускающие</h3>
						</div>
						<div class="wow fadeInUp" data-wow-duration="2s">
							<img src="../../public/images/texnology-item3.jpg" alt="img">
							<h3>С фотопечатью</h3>
						</div>
						<div class="wow fadeInRight" data-wow-duration="2s">
							<img src="../../public/images/texnology-item4.jpg" alt="img">
							<h3>Звездное небо</h3>
						</div>						
					</div>
				</div>
				...
				<div class="row">
					<div class="col-12 d-flex justify-content-between align-items-center flex-wrap">
						<div class="h2-block wow fadeInLeft" data-wow-duration="2s">
							...
							<span class="first"><img src="../../public/images/check.png" alt="icon">Скидка на каждый третий<br>натяжной потолок 20%</span>
							<span><img src="../../public/images/check.png" alt="icon">Каждый 5-й светильник<br>в подарок</span>
						</div>
			...
			<div class="row">
				<div class="col-12 grid">
					<div class="item wow fadeInLeft" data-wow-duration="2s">
						<img src="../../public/images/for-item1.jpg" alt="img">
						<span>Спальни</span>
					</div>
					<div class="item wow fadeInUp" data-wow-duration="2s">
						<img src="../../public/images/for-item2.jpg" alt="img">
						<span>Гостинной</span>
					</div>
					<div class="item wow fadeInRight" data-wow-duration="2s">
						<img src="../../public/images/for-item3.jpg" alt="img">
						<span>Детской</span>
					</div>
					<div class="item wow fadeInLeft" data-wow-duration="2s">
						<img src="../../public/images/for-item4.jpg" alt="img">
						<span>Кухни</span>
					</div>
					<div class="item wow fadeInUp" data-wow-duration="2s">
						<img src="../../public/images/for-item5.jpg" alt="img">
						<span>Ванной и туалета</span>
					</div>
					<div class="item wow fadeInRight" data-wow-duration="2s">
						<img src="../../public/images/for-item6.jpg" alt="img">
						<span>Офиса</span>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12">
					...
					<div class="items">
						...
						<div class="item item2 wow fadeInUp" data-wow-duration="2s">
							<img src="../../public/images/avatar2.jpg" alt="img">
						...
						<div class="item item3 wow fadeInRight" data-wow-duration="2s">
							<img src="../../public/images/avatar3.jpg" alt="img">
		...
		<div id="map">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<div class="places">
							<img class="places-logo" src="../../public/images/logo.png" alt="logo">
							<span>г. Москва, Красная площадь, с лева</span>
							<div>
						    	<img src="../../public/images/phone-icon.png" alt="img">
			...
			<div class="row">
				<div class="col-12">
					...
					<div class="footer-contacts">
						<a class="link-tel" href="tel:+77777777777"><img src="../../public/images/tel.png" alt="icon">+7 (777) 777 77 77</a>
						<a class="link-mail" href="mailto:натяжные-потолки@gmail.com"><img src="../../public/images/mail.png" alt="icon">натяжные-потолки@gmail.com</a>
					</div>
				</div>
			</div>
		</div>
